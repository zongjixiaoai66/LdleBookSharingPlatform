...
var centerMenu = [
    ...
    ,{
        name: '图书借阅评价',
        url: '../tushuCommentback/list2.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/tushufenxiangpingtai/admin/dist/index.html#/login";
