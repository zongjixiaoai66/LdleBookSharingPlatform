    ...
    */
    ...
    public R save(@RequestBody TushuEntity tushu, HttpServletRequest request){
        ...
        Wrapper<TushuEntity> queryWrapper = new EntityWrapper<TushuEntity>()
            ...
            .eq("zan_number", tushu.getZanNumber())
            .eq("cai_number", tushu.getCaiNumber())
            .eq("tushu_types", tushu.getTushuTypes())
            .eq("tushu_zhuangtai_types", tushu.getTushuZhuangtaiTypes())
...
//                            tushuEntity.setTushuAddress(data.get(0));                    //现在位置 要改的
//                            tushuEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            tushuEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
...
//                            tushuEntity.setTushuZhuangtaiTypes(Integer.valueOf(data.get(0)));   //图书状态 要改的
    ...
    */
    ...
    public R add(@RequestBody TushuEntity tushu, HttpServletRequest request){
        ...
        Wrapper<TushuEntity> queryWrapper = new EntityWrapper<TushuEntity>()
            ...
            .eq("tushu_zhuangtai_types", tushu.getTushuZhuangtaiTypes())
            .eq("tushu_delete", tushu.getTushuDelete())
//            .notIn("tushu_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        TushuEntity tushuEntity = tushuService.selectOne(queryWrapper);
        if(tushuEntity==null){
                tushu.setZanNumber(1);
                tushu.setCaiNumber(1);
            tushu.setTushuClicknum(1);
            tushu.setTushuDelete(1);
            tushu.setInsertTime(new Date());
            tushu.setCreateTime(new Date());
