...
public class TushuOrderView extends TushuOrderEntity implements Serializable {
	...
	* 借阅类型的值
	*/
	@ColumnInfo(comment="借阅类型的字典表值",type="varchar(200)")
	private String tushuOrderValue;
	/**
	* 审核状态的值
	*/
	@ColumnInfo(comment="审核状态的字典表值",type="varchar(200)")
	private String tushuOrderYesnoValue;
	...
	* 获取： 审核状态的值
	*/
	public String getTushuOrderYesnoValue() {
		return tushuOrderYesnoValue;
	}
	/**
	* 设置： 审核状态的值
	*/
	public void setTushuOrderYesnoValue(String tushuOrderYesnoValue) {
		this.tushuOrderYesnoValue = tushuOrderYesnoValue;
	}
	...
	public String toString() {
		return "TushuOrderView{" +
			...
			", tushuOrderYesnoValue=" + tushuOrderYesnoValue +
