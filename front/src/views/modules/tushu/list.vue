        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '出版社' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.tushuChubanshe" placeholder="出版社" clearable></el-input>
                     </el-form-item>
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '图书状态' : ''">
                        <el-select v-model="searchForm.tushuZhuangtaiTypes" placeholder="请选择图书状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in tushuZhuangtaiTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/tushufenxiangpingtai/upload/tushuMuBan.xls"
                        >批量导入图书数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('tushu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="tushuZhuangtaiTypes"
                                      header-align="center"
                                      label="图书状态">
                        <template slot-scope="scope">
                            {{scope.row.tushuZhuangtaiValue}}
                        </template>
                    </el-table-column>
