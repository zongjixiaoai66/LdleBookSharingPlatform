    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现在位置" prop="tushuAddress">
                       <el-input v-model="ruleForm.tushuAddress"
                                 placeholder="现在位置" clearable  :readonly="ro.tushuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现在位置" prop="tushuAddress">
                           <el-input v-model="ruleForm.tushuAddress"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="图书介绍" prop="tushuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tushuContent" label="图书介绍" prop="tushuContent">
                            <span v-html="ruleForm.tushuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="图书状态" prop="tushuZhuangtaiTypes">
                        <el-select v-model="ruleForm.tushuZhuangtaiTypes" :disabled="ro.tushuZhuangtaiTypes" placeholder="请选择图书状态">
                            <el-option
                                v-for="(item,index) in tushuZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="图书状态" prop="tushuZhuangtaiValue">
                        <el-input v-model="ruleForm.tushuZhuangtaiValue"
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=tushu_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.tushuZhuangtaiTypesOptions = data.data.list;
                    }
                });
