...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import dictionaryTushuOrderYesno from '@/views/modules/dictionaryTushuOrderYesno/list'
    import dictionaryTushuZhuangtai from '@/views/modules/dictionaryTushuZhuangtai/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryTushuOrderYesno',
        name: '申请状态',
        component: dictionaryTushuOrderYesno
    }
    ,{
        path: '/dictionaryTushuZhuangtai',
        name: '图书状态',
        component: dictionaryTushuZhuangtai
    }
    ,{
        path: '/config',
        name: '轮播图',
